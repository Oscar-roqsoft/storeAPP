           ...
           <div class="w-full mx-auto">
               <navbar />
                ...
                flex justify-between items-center px-[20px] pt-[16px]">
                    ...
                    <div>
                        <img src="/public/img/Highlight_05.png" class="absolute  top-[10px] left-[30vw]">
                        <h1 class="text-xl">Explore</h1>
                    </div>
                    <div class="" >
                        <img src="/public/home-img/Ellipse886.png" class="absolute animate-ping top-[24px] right-[21px]">
                        <img src="/public/home-img/Frame31.png" >
                    </div>
                </section>
                ...
                <section class="mt-4  px-4">
                    ...
                    <div class="min-h-[107px] grid grid-cols-2 bg-white rounded-xl">
                        ...
                        <div class="flex place-items-center justify-center">
                            <img src="/public/home-img/Misc_06.png" class="relative top-[-17px] left-[45px]">
                            <img src="/public/home-img/Nike-Zoom.png"  class="relative top-[-24px] left-[29px]" >
                            <img src="/public/home-img/Ellipse3.png"  class="relative top-[28px] right-[77px]">
                        </div>
                    </div>
                </section>
           </div>
